...
def get_product_urls(keyword: str, num_pages: int):
    ...
    for page_number in range(1, num_pages + 1):
        category_url = f'https://searchlist-api.sendo.vn/web/products?q={keyword}&platform=web&page={page_number}&size=30&sortType=rank'
...
def get_product_details(product_url: str):
    ...
    if response.status_code == 200:
        ...
        product_data = {
            ...
            "productDescription": data.get("short_description"),
...
keyword = ['Áo sơ mi', 'Áo thun', 'Áo khoác']
num_pages = 1
